    ...
    return (
      <View style={[styles.buttonContainer]}>
        <Pressable
          ...
          onPress={onPress}
        >
          <FontAwesome name="google" size={26} color="#4385f5" />
          <Text style={[styles.buttonLabel, { color: "black" }]}> </Text>
          <Text style={[styles.buttonLabel, { color: "black", fontSize: 16 }]}>
            {label}
          </Text>
        </Pressable>
      </View>
    ...
    return (
      <View style={[styles.buttonContainerHalf]}>
        <Pressable
          ...
          onPress={onPress}
        >
          <FontAwesome name="check" size={16} color="gray" />
          <Text style={[styles.buttonLabel, { color: "gray", fontSize: 14 }]}>
            {label}
          </Text>
        </Pressable>
      </View>
    ...
    return (
      <View
        style={[
          ...
          { borderWidth: 4, borderColor: "ffd33d", borderRadius: 8 },
        ]}
      >
        <Pressable
          ...
          onPress={onPress}
        >
          <FontAwesome name="exclamation" size={18} color="#25292e" />
  ...
  if (theme === "addtypetext") {
    return (
      <View
        style={[
          styles.buttonContainerHalf,
          { borderWidth: 0, borderColor: "transparent", borderRadius: 3 },
        ]}
      >
        <Pressable
  ...
  if (theme === "type-selected") {
    return (
      <View
        style={[
          styles.buttonContainerThird,
          { borderWidth: 2, borderColor: "#6CD049", borderRadius: 7 },
        ]}
      >
        <Pressable
          style={[styles.button, { backgroundColor: background }]}
  ...
  return (
    <View
      style={[
        ...
        { borderWidth: 1, borderColor: "ffd33d", borderRadius: 5 },
      ]}
    >
      <Pressable
        style={[styles.button, { borderRadius: 3, backgroundColor: "#C3CBCA" }]}
        onPress={onPress}
      >
